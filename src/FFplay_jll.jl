...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import FFplay_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("c4dce911-e170-5107-8314-c7bdc6785395"))
platforms = [Pkg.Artifacts.unpack_platform(e, "FFplay", artifacts_toml) for e in artifacts["FFplay"]]
...
if best_platform === nothing
    @debug("Unable to load FFplay; unsupported platform $(triplet(platform_key_abi()))")
else
